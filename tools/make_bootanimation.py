...
class Composer:
    ...
    def __init__(self, width, height, rotate):
        ...
        short = min(self.cw, self.ch)
        self.dot_r = short * 0.038       # dot radius at rest
        self.ring_r = short * 0.130      # orbit radius at rest
        self.row_gap = short * 0.105     # spacing of the fly-in row
...
def build(args):
    ...
    for i in range(n_intro):
        ...
        save_frame(comp.render(comp.intro_frame(t)),
                   os.path.join(p0, "%04d.png" % i), args.colors)
    ...
    for i in range(n_loop):
        ...
        t = i / float(n_loop)
        save_frame(comp.render(comp.loop_frame(t)),
                   os.path.join(p1, "%04d.png" % i), args.colors)
